...
#ifndef __WINDOWS_DISK_ISOLATOR_HPP__
#define __WINDOWS_DISK_ISOLATOR_HPP__
...
class WindowsDiskIsolatorProcess : public MesosIsolatorProcess
{
public:
  static Try<mesos::slave::Isolator*> create(const Flags& flags);

  virtual ~WindowsDiskIsolatorProcess();
...
private:
  WindowsDiskIsolatorProcess(const Flags& flags);
...
#endif // __WINDOWS_DISK_ISOLATOR_HPP__
